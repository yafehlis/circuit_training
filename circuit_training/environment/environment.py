...
class CircuitEnv(object):
  ...
  def __init__(
    ...
    if self._std_cell_placer_mode == 'dreamplace':
        raise NotImplementedError("Dreamplace has not been insalled. Use without dreamplace")
        pass
  ...
  def analytical_placer(self) -> None:
    if self._std_cell_placer_mode == 'dreamplace':
        raise NotImplementedError("Dreamplace is not installed in this version. Use without dreamplace.")
        pass
